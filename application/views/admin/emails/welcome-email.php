<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Welcome Email Prefrence</h4>
        </div>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        ?>
        <?php echo form_open('admin/set_welcome_email'); ?>
        <textarea name="mail_body" id="code" cols="30" rows="10"><?php echo $get_welcome_temps->mail_body; ?></textarea>
        <br>
