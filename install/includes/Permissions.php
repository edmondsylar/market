...
{  
    ...
    public function extensionCheck($extensions=null) 
    {
        ...
        if (version_compare(phpversion(), '7.0.0', '<')) {
            ...
            $fail[] = 'You need<strong> PHP 7.0.0</strong> (or greater;<strong>Current Version:'.phpversion().')</strong>';
            //set error status for php version
            $fail_status[] = '<span class="label label-danger">Error</span>';
        } else {
            //set success message for php version
            $pass[] ='You have<strong> PHP 7.0.0</strong> (or greater; <strong>Current Version:'.phpversion().')</strong>';
