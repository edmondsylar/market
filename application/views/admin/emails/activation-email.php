<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Account Activation Email Prefrence</h4>
        </div>
    </div>
</div>
...
<div class="card">
    ...
    <h3 class="text-center">Present your Welcome email</h3>
    ...
    <div class="card-body">
        ...
        ?>
        <?php echo form_open('admin/set_activation_email'); ?>
        <textarea name="mail_body" id="code" cols="30" rows="10"><?php echo $get_activate_temps->mail_body; ?></textarea>
        <br>
