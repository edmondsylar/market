...
jQuery(document).ready(function (a) {
    ...
    if (h.length > 0 && (a(window).on("scroll", function () {
            ...
            iziToast.show(h)
        }), a("#wishlist-action").on("click", function () {
            ...
            switch (b) {
                case 1:
                    a(this).addClass("active"), c.class = "iziToast-info", c.message = "has been added to your wishlist!", c.icon = "icon-bell";
                    break;
                case 2:
                    a(this).removeClass("active"), c.class = "iziToast-info", c.message = "has been added to your wishlist!", c.icon = "icon-ban"
            }
